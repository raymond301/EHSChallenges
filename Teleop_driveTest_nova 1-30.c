...
task main()
{
  ...
  while (true)
  {
    ...
    {
      motor[mtr_S1_C1_1] = joystick.joy1_y2/2;         // Motor B is assigned a power level equal to the right analog stick's Y-axis reading.
    }
    ...
    {
      motor[mtr_S1_C1_2] = joystick.joy1_y1/2;         // Motor C is assigned a power level equal to the left analog stick's Y-axis reading.
    }
    else                                   // Else if the readings are within the threshold:
    {
